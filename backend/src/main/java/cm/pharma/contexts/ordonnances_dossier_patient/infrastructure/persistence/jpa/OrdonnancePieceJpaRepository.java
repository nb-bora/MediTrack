...
public interface OrdonnancePieceJpaRepository extends JpaRepository<OrdonnancePieceJpaEntity, UUID> {
    ...
    List<OrdonnancePieceJpaEntity> findByOrganisationIdAndOrdonnanceId(UUID organisationId, UUID ordonnanceId);

    Optional<OrdonnancePieceJpaEntity> findByOrganisationIdAndId(UUID organisationId, UUID id);
}
